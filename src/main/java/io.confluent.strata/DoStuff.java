...
public class DoStuff {
    ...
    public static void main(String argv[])  {
        ...
        ReverseGeocoder reverseGeocoder = new ReverseGeocoder(Lists.newArrayList(nyShapefile, njShapefile));

        //penn station
        //y 40.7515906, x -74.0045378
        System.out.printf("%s\n", reverseGeocoder.findGeoInfoForPoint(-74.0045378, 40.7515906));

        // upper west side
        //y 40.7634559,x -73.994967
        System.out.printf("%s\n", reverseGeocoder.findGeoInfoForPoint(-73.994967, 40.7634559));

        // lincoln tunnel
        // y 40.759588, x -74.002220
        System.out.printf("%s\n", reverseGeocoder.findGeoInfoForPoint(-74.002220, 40.759588));
